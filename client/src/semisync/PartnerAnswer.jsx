...
import { Box, Card, Container, Typography, Stack } from "@mui/joy";
...
export default function PartnerAnswer({ next, back }) {
  ...
  const partnerAnswer =
    player.get("partnerAnswer") ||
    'No answer submitted, please click "Neutral" to continue.';
    ...
    >
      ...
      <Typography level="body-md" textAlign="center">
        ...
        <span style={{ color: "rgb(102, 93, 245)" }}>
          You will wait a maximum of {msToTime(timeLeft)}.
        </span>
      </Typography>
  ...
  return <Container maxWidth="100vw">{stepUI}</Container>;
}
