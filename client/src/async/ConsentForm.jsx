  ...
  return (
    <Container maxWidth="100vw">
      <Stack
        ...
        gap={1}
      >
        <Typography level="h1">Consent Form (STUDY2021_00000280)</Typography>
        <strong>
          Please read the following information. When you give your consent, you
          can proceed to the task. In this consent form, we refer to the current
          study as a Human Intelligence Task (HIT).
        </strong>
        <Card
          variant="soft"
