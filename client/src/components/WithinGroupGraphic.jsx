...
export default function WithinGroupGraphic({
  ...
  return (
    <div className={"withinGroupGraphic " + politicalClasses[politicalIdx]}>
      <span className="material-symbols-outlined icon-center">
        partner_exchange
      </span>
      You and your partner are grouped with millions of Americans who all{" "}
      {opinionText} with this statement: "{opinionStatement}".
    </div>
  );
}
