...
import { Button, FormControl, FormLabel, Input, Container, Typography, Stack, Alert } from '@mui/joy';
            ...
            <Stack sx={{
                ...
                <form onSubmit={handleSubmit}>
                    <FormControl>
                        ...
                        <Input placeholder="Type in here…" value={playerID} onChange={e=> setPlayerID(e.target.value)} />
                    </FormControl>
                </form>
                ...
                <Button color="primary" sx={{
                    ...
                    width: '10rem',
                    mx: 'auto',
                    mb: '2rem'}} onClick={handleSubmit}>Submit</Button>
            </Stack>
        </Container>
        );
    }